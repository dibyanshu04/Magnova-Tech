    ...
    var settings = $.extend(
      {
        ...
        captionFormat:
          "{0} Selected" /* format of caption text. you can set your locale.*/,
        captionFormatAllSelected:
          "{0} all selected!" /* format of caption text when all elements are selected. set null to use captionFormat. It will not work if there are disabled elements in select.*/,
    ...
    var ret = this.each(function () {
      ...
      this.sumo = {
            ...
            for (i = 0; i < sels.length; i++) {
              if (i + 1 >= settings.csvDispCount && settings.csvDispCount) {
                if (
                  ...
                  O.placeholder =
                    settings.captionFormat.replace(/\{0\}/g, sels.length) + ",";
                }
        ...
        setNativeMobile: function () {
          ...
          O.E.addClass(
            "SelectClass"
          ); /* .css('height', O.select.outerHeight()); */
          O.mob = true;
          O.E.change(function () {
            O.setText();
          });
